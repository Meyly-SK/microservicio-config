...
public class ProductoServiceImpl extends CommonServiceImpl<Producto, ProductoRepository> implements ProductoService {
	...
	public Proveedor obtenerProveedoraPorId(Long proveedorId) {
		// TODO Auto-generated method stub
		try {
	        Proveedor proveedorDTO = clientProveedor.obtenerProveedorPorId(proveedorId);
