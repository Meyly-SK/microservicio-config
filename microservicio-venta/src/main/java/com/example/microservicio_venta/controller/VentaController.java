...
public class VentaController extends CommonController<Venta, VentaService>{
	...
	public ResponseEntity<byte[]> generarPdfReporte(@PathVariable Long id) throws Exception {
		...
		byte[] pdf = service.generarPdfVenta(venta.get());
