...
import com.example.microservicio_venta.models.Cliente;
...
import com.example.microservicio_venta.repository.VentaRepository;
...
public class VentaServiceImpl extends CommonServiceImpl<Venta, VentaRepository> implements VentaService{
	...
	public byte[] generarPdfVenta(Venta venta) throws Exception{
		...
		document.add(new Paragraph("Fecha: " + new SimpleDateFormat("dd/MM/yyyy HH:mm").format(venta.getFecha())));
